...
S("You feel more experienced in demon fighting!", "你觉得自己与恶魔战斗得更熟练了！")
S("Cthulhu withdraws his tentacle!", "克苏鲁缩回他的触手！")
S("The sandworm explodes in a cloud of Spice!", "沙虫爆炸成一片香料云！")
...
S("You wonder what does it mean?", "你想知道那是什么意思。")
...
S("Your brain is steaming.", "你感觉大脑要在飞速运转中煮沸了。")
S("%The1 destroys %the2!", "%1摧毁了%2！")
